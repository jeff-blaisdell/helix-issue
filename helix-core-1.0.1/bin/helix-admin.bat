...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="helix-admin" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.tools.ClusterSetup %CMD_LINE_ARGS%
