...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="start-helix-participant" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.examples.ExampleProcess %CMD_LINE_ARGS%
