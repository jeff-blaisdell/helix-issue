...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="run-helix-controller" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.controller.HelixControllerMain %CMD_LINE_ARGS%
