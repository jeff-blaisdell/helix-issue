...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="quickstart" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.apache.helix.examples.Quickstart %CMD_LINE_ARGS%
